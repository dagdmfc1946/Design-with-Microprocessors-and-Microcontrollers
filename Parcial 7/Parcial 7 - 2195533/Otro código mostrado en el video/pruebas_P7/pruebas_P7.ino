...
void touchCallbackMin() {
  dutyCycle = map(40, 0, 100, 0, 255); // Cambiar el ciclo de trabajo al 20%
  fActual = 10;                      // Cambiar la frecuencia a 500 Hz
...
void touchCallbackMax() {
  dutyCycle = map(40, 0, 100, 0, 255); // Cambiar el ciclo de trabajo al 75%
  fActual = 100;                      // Cambiar la frecuencia a 5000 Hz
  analogWriteFrequency(ledPin, fActual); // Aplicar cambios de frecuencia
  analogWrite(ledPin, dutyCycle); // Aplicar cambios de ciclo de trabajo
}

void touchCallbackDec() {
  dutyCycle = map(80, 0, 100, 0, 255); // Cambiar el ciclo de trabajo al 100%
  fActual = 300000;                      // Cambiar la frecuencia a 10000 Hz
  analogWriteFrequency(ledPin, fActual); // Aplicar cambios de frecuencia
  analogWrite(ledPin, dutyCycle); // Aplicar cambios de ciclo de trabajo
}

void touchCallbackInc() {
  dutyCycle = map(80, 0, 100, 0, 255); // Cambiar el ciclo de trabajo al 50%
  fActual = 310000;                      // Cambiar la frecuencia a 1000 Hz
  analogWriteFrequency(ledPin, fActual); // Aplicar cambios de frecuencia
  analogWrite(ledPin, dutyCycle); // Aplicar cambios de ciclo de trabajo
}
